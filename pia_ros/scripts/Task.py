...
class Task():
	...
	def __init__(self, name, resources, duration, precedence, location_X, location_Y):
		# This function initializes object of the class Task with attributes name,
		# task resources, task duration time and coordinates X and Y.
	...
	def to_task(cls, msg):
		...
		return cls(msg.name, msg.resources, msg.duration, msg.precedence, msg.location_X, msg.location_Y)