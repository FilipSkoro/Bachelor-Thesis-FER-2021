...
class Robot():
	...
	def __init__(self, name, velocity, resources, location_X, location_Y):
		...
		# name, velocity, resources and coordinates X and Y. Furthermore it creates lists Tauc and
	...
	def declare_end_callback(self, req):
		...
		if req.end:
			...
			print(f'Total schedule time: {self.get_Schedule_Time(self.robot_schedule)} seconds\n')
			#quit()
